...
function MM_swapImage() { //v3.0
  var i,j=0,x,a=MM_swapImage.arguments; document.MM_sr=new Array; for(i=0;i<(a.length-2);i+=3)
   if ((x=MM_findObj(a[i]))!=null){document.MM_sr[j++]=x; if(!x.oSrc) x.oSrc=x.src; x.src=a[i+2];}
	...
	function verify()
	{
		if(document.fData.rPassold.value.length < 5 )
		{
			alert("La Contraseña Antigua tiene que tener al menos 5 caracteres ... !");
			document.fData.rPassold.focus();
			return false;
		}
		if(document.fData.rPassnew.value.length < 5 )
		{
			alert("La Contraseña Nueva tiene que tener al menos 5 caracteres ... !");
			document.fData.rPassnew.focus();
			return false;
		}
		
		if(document.fData.rPassnew.value != document.fData.rPassnew2.value )
		{
   ...
   <td align="center" valign="top"><form action="<?=$vFile.'?'.SID?>" method="post" name="fData" id="fData">
     ...
     <table border="0" cellpadding="0" cellspacing="0">
       ...
       <tr>
         ...
         <td align="center" background="../../images/ventana_r1_c2.jpg" class="tlargebb">
           <p><strong>Cambio de Contrase&ntilde;a</strong></p></td>
         <td><img name="ventana_r1_c4" src="../../images/ventana_r1_c4.jpg" width="11" height="29" border="0" alt=""></td>
       </tr>
       <tr>
         <td background="../../images/ventana_r2_c1.jpg"></td>
         <td background="../../images/ventana_r2_c2.jpg" class="tnormalbn"><div align="right">(Los campos marca con <span class ='timporbb'>#</span> son olbligatorios)<br>
                 <hr noshade>
                 <table width="500" border="0" cellpadding="0" cellspacing="0" class="tnormalbn">
                   <tr>
                     <td width="150" align="right"><span class ='timporbb'>#</span> Contrase&ntilde;a Antigua :</td>
                     <td width="350"><input name="rPassold" type="password" class="otexto" id="rPassold" size="25" maxlength="25">
                (M&iacute;n. 5 Caracteres. Max 25 Caracteres) </td>
                   </tr>
                   <tr>
                     <td align="right"><span class ='timporbb'>#</span> Contrase&ntilde;a Nueva :</td>
                     <td><input name="rPassnew" type="password" class="otexto" id="rPassnew" size="25" maxlength="25">
                (M&iacute;n. 5 Caracteres. Max 25 Caracteres) </td>
                   </tr>
                   <tr>
                     <td align="right"><span class ='timporbb'>#</span> Repita Contrase&ntilde;a : </td>
                     <td><input name="rPassnew2" type="password" class="otexto" id="rPassnew2" size="25" maxlength="25">
                (M&iacute;n. 5 Caracteres. Max 25 Caracteres)</td>
                   </tr>
                   <tr>
                     <td colspan="2" align="center"><input name="Submit" type="submit" class="oboton" value="Cambiar" onClick = "if(verify()){ document.fData.submit();} return false"></td>
                   </tr>
                 </table>
         </div></td>
