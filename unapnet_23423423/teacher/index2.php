...
if($boton) {
	if (is_uploaded_file($_FILES['archivo']['tmp_name'])) { 
		copy($_FILES['archivo']['tmp_name'], "/var/www/html/unapnet2/unapnet/teacher/upload/".$_FILES['archivo']['name']);
		$subio = true;
	}
     ...
     <tr>
       ...
       <td align="center" background="../../images/ventana_r2_c2.jpg" class="tnormalbn"><div align="center">
         <p class="Estilo1">El ingreso de Notas a Actas via Internet inici&oacute; el <strong>Martes 26 de Junio del 2007</strong>.<br>
           Por la gran demanda de parte de los docentes por ingresar las Notas a Actas via internet, exitieron problemas que opstaculizaron el normal ingreso de las notas y el cumplimiento del cronograma. En tal sentido se amplia el  &uacute;ltimo d&iacute;a para el ingreso de Notas via Internet hasta el d&iacute;a <strong>Martes 10 de Julio del 2007</strong> hasta las <strong>10:59 de la ma&ntilde;ana</strong>.		 </p>
         <form action="<?=$PHP_SELF?>" method="post" enctype="multipart/form-data" name="form1">
		 Envio de S&iacute;labus:<br> 
		 <?
		 	if($subio) {

				echo "El archivo: ".$_FILES['archivo']['name']." subio con exito";
			} else {
				echo "El archivo no cumple con las reglas establecidas";	
			}
			$boton = "";
