<?php
	...
	if(!empty($sCarrera[$vCod_car]))
	{
		...
		if($vCan_cap > 0)
		{
			...
			$vQuery .= "mn.mod_act = '$vMod_mat' and no.cod_car = '$vCod_car' and no.tip_not = 'C' and no.num_mat in ";
			$vQuery .= "(Select num_mat from $tCurmat where per_aca = '{$sUser['per_aca']}' and ";
			$vQuery .= "pln_est = '$vPln_est' and cod_cur = '$vCod_cur' and ";
			$vQuery .= "sec_gru = '$vSec_gru')";
		...
		if($vCan_act > 0)
		{
			...
			$vQuery .= "where no.pln_est = '$vPln_est' and no.cod_cur = '$vCod_cur' and ";
			$vQuery .= "no.per_aca = '{$sUser['per_aca']}' and no.ano_aca = '{$sUser['ano_aca']}' and ";			
			$vQuery .= "mn.mod_act = '$vMod_mat' and no.cod_car = '$vCod_car' and no.tip_not = 'A' and no.num_mat in ";
			$vQuery .= "(Select num_mat from $tCurmat where per_aca = '{$sUser['per_aca']}' and ";
			$vQuery .= "pln_est = '$vPln_est' and cod_cur = '$vCod_cur' and ";
			$vQuery .= "sec_gru = '$vSec_gru')";
...
<!-- fwtable fwsrc="docen.png" fwbase="index.jpg" fwstyle="Dreamweaver" fwdocid = "377833132" fwnested="0" -->
   ...
   <td align="center" valign="top"><span class="celdapar"><span class="celdapar"><table border="0" cellpadding="0" cellspacing="0">
       ...
       <tr>
         ...
         <td align="center" background="../../images/ventana_r2_c2.jpg" class="tnormalbn"><table border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" class="tnormalbn">
             ...
             <?	if($vCod_car == '23' or $vCod_car == '56' or $vCod_car == '35' or $vCod_car == '65' or ($vMod_mat == '02' or $vMod_mat == '08'))
			...
			?>
			 <tr>
               ...
               <td>&nbsp;</td>
               <td>&nbsp;</td>
               <td align="center"><? if($vCan_cap < 6) {?><a href="actadd.php?rSendData=<?=$vSendData?>49433<?=$vCan_cap+1?>" title="Agregar Nota de Capacidades">Agr</a><? } if($vCan_cap > 0) {?>-<a href="actadel.php?rSendData=<?=$vSendData?>49433<?=$vCan_cap?>" title="Borrar última Nota de las Capacidades">Bor</a><? } ?></td>
               <td>&nbsp;</td>
               <td align="center"><? if($vCan_act < 4 and $vMod_mat != '08') {?><a href="actadd.php?rSendData=<?=$vSendData?>49413<?=$vCan_act+1?>" title="Agregar Nota de Actitudes">Agr</a><? } if($vCan_act > 0) {?>-<a href="actadel.php?rSendData=<?=$vSendData?>49413<?=$vCan_act?>" title="Borrar última Nota de las Actitudes">Bor</a><? } ?></td>
               <td>&nbsp;</td>
               <td>&nbsp;</td>
             </tr>
             ...
             <tr>
               ...
               <td><table border="1" cellpadding="0" cellspacing="0" bordercolor="#E8E8E8" >
                 <tr class="celdainpar">
                   ...
                   <td width="17" align="center"><a href="actadd.php?rSendData=<?=$vSendData?>55433<?=$i+1?>" title="Modificar Nota de Capacidad <?=$i+1?>">M</a></td>
					<?	}	?>
                 </tr>
               </table></td>
               <td>&nbsp;</td>
               <td><table border="1" cellpadding="0" cellspacing="0" bordercolor="#E8E8E8" >
                 <tr class="celdainpar">
                   ...
                   <td width="13" align="center"><a href="actadd.php?rSendData=<?=$vSendData?>55413<?=$i+1?>" title="Modificar Nota de Actitud <?=$i+1?>">M</a></td>
					<?	}	?>
                 </tr>
               </table></td>
               <td>&nbsp;</td>
			...
			?>
             <tr <? if($vCont % 2 == 0) echo "class=\"celdapar\""; else echo "class=\"celdainpar\"";?>>
               ...
               <td>&nbsp;<?=$vApe_nom?>&nbsp;</td>
               <td>&nbsp;<?=(($vMod_mat == '08')?($sModnot[$aEstumat['mod_mat']]):($sModmat[$aEstumat['mod_mat']]))?>&nbsp;</td>
               <td><table border="1" cellpadding="0" cellspacing="0" bordercolor="#E8E8E8" >
                 <tr class="celdainpar">
			...
			<?	}	?>
             ...
             <table border="1" cellpadding="0" cellspacing="0" bordercxolor="#FFFFFF">
           </table></td>
  ...
  <a href="prnactax.php?rSendData=<?=$vSendData?>" title="Exportar Excel">Exportar Excel </a></span></span></td>
