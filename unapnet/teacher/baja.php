     ...
     <table border="0" cellpadding="0" cellspacing="0">
       ...
       <tr>
         ...
         <td align="center" background="../../images/ventana_r1_c2.jpg" class="tlargebb">
           <p><strong>Dar de baja la cuenta de usuario </strong></p></td>
       ...
       <tr>
         ...
         <td background="../../images/ventana_r2_c2.jpg" class="tnormalbn"><div align="right">(Los campos marca con <span class ='timporbb'>#</span> son olbligatorios)<br>
                 ...
                 <table width="500" border="0" cellpadding="0" cellspacing="0" class="tnormalbn">
                   <tr>
                     <td width="150" align="right"><span class ='timporbb'>#</span> Contrase&ntilde;a :</td>
                     <td width="350"><input name="rPasswd" type="password" class="otexto" id="rPasswd3" size="25" maxlength="25">
                (M&iacute;n. 5 Caracteres. Max 25 Caracteres) </td>
                   </tr>
                   <tr>
                     <td align="right"><span class ='timporbb'>#</span> Repita Contrase&ntilde;a : </td>
                     <td><input name="rPasswd2" type="password" class="otexto" id="rPasswd23" size="25" maxlength="25">
                (M&iacute;n. 5 Caracteres. Max 25 Caracteres)</td>
                   </tr>
                   <tr>
                     <td colspan="2" align="center"><input name="Submit" type="submit" class="oboton" value="Dar de Baja" onClick = "if(verify()){ document.fData.submit();} return false"></td>
                   </tr>
                 </table>
         </div></td>
