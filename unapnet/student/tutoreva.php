...
/*	$vHtml = "";
	...
	$vQuery .= "per_aca = '{$sTutor['per_pas']}' and $tPlan.cod_car = '{$sUser['cod_car']}' order by pln_est, cod_cur, mod_not ";
...
/*	$vQuery = "Select pln_est, cod_cur, count(*) as veces from $tNota where pln_est = '{$sTutor['pln_est']}' and ";
	...
	$xSerdata->close();
	$sTutor['crd_maxt'] = $sTutor['crd_max'];		*/
	...
	if($sUser['tip_sist'] == '2')
	{
		...
		$vQuery .= "and $tNota.cod_car = $tCurso.cod_car where $tNota.num_mat = '{$sUser['codigo']}' and $tNota.ano_aca = '{$sUser['ano_aca']}' and ";
		$vQuery .= "$tNota.per_aca = '{$sUser['per_aca']}' ";
		
		$cNota = fQuery($vQuery);
		while($aNota = mysql_fetch_array($cNota))
		{
		...
		$vQuery .= "not_cur > 10) group by cod_cur order by veces desc";		
		$cCurdes = fQuery($vQuery);	
		if($aCurdes = mysql_fetch_array($cCurdes))
			$vVeces = $aCurdes['veces'];
		fModestudia($vVeces, $vPromedio, $vCrdapro);
...
<table border="0" cellpadding="0" cellspacing="0">
       ...
       <tr>
         ...
         <td align="center" background="../../images/ventana_r1_c2.jpg" class="tlargebb"> Situaci&oacute;n Acad&eacute;mica  (
           <?=$sUser['ano_aca']?>
-
<?=$sPeriodo[$sUser['per_aca']]?>
)</td>
       ...
       <tr>
         ...
         <td align="center" background="../../images/ventana_r2_c2.jpg" class="tnormalbn"><table border="0" cellpadding="0" cellspacing="1" class="tnormalbn">
           <tr>
             ...
             <td><strong><?=$sModmat[$sUser['mod_mat2']]?> </strong></td>
           </tr>
           <tr>
           ...
           <tr>
             ...
             <td><strong><?=$vCrdapro?> Créditos</strong></td>
           </tr>
           <tr>
             <td align="right">Promedio Ponderado Semestral : </td>
             <td><strong><?=$vPromedio?></strong></td>
           </tr>
         </table></td>
     ...
     <table border="0" cellpadding="0" cellspacing="0">
       ...
       <tr>
         <td><img name="ventana_r1_c1" src="../../images/ventana_r1_c1.jpg" width="12" height="29" border="0" alt=""></td>
         <td align="center" background="../../images/ventana_r1_c2.jpg" class="tlargebb"> Situaci&oacute;n Acad&eacute;mica 2005-Periodo I</td>
         <td><img name="ventana_r1_c4" src="../../images/ventana_r1_c4.jpg" width="11" height="29" border="0" alt=""></td>
       </tr>
       <tr>
         <td background="../../images/ventana_r2_c1.jpg"></td>
         <td align="center" background="../../images/ventana_r2_c2.jpg" class="tnormalbn"><table border="0" cellpadding="0" cellspacing="1" class="tnormalbn">
             <tr>
               ...
               <td width="180"><strong><?=$sModmat[$sUser['mod_mat']]?></strong></td>
             </tr>
             <tr>
               <td align="right">M&aacute;ximo de cr&eacute;ditos a Matricular : </td>
               <td><strong><?=$sUser['max_crd']?> Créditos</strong></td>
             </tr>
             <tr>
               <td align="right">Especialidad : </td>
               <td> <strong>
			   <?  if($sUser['cod_esp'] == '00') {	?>
			   	<select name="rCod_esp" class="ocombo" id="rCod_esp">
                 <?=fviewesp()?>
                              </select>
				<? } else $sEspecial[$sUser['cod_esp']]; ?>
				</strong></td>
             </tr>
         </table></td>
         <td background="../../images/ventana_r2_c4.jpg"></td>
