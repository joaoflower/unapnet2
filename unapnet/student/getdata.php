...
<table border="0" cellpadding="0" cellspacing="0">
       ...
       <tr>
         ...
         <td align="center" background="../../images/ventana_r1_c2.jpg" class="tlargebb">Datos de usuario <br>         </td>
         ...
         <td background="../../images/ventana_r2_c2.jpg" class="tnormalbn"><table width="500" border="0" cellpadding="0" cellspacing="0" class="tnormalbn">
             <tr>
               ...
               <td width="350"><select name="rTip_doc" class="ocombo" id="rTip_doc">
                 ...
                 N&uacute;mero :
                  <input name="rNum_doc" type="text" class="otexto" id="rNum_doc" value="<?=$sUser['num_doc']?>" size="10" maxlength="10"></td></tr>
             <tr>
