...
<!-- fwtable fwsrc="estdoc.png" fwbase="index.jpg" fwstyle="Dreamweaver" fwdocid = "377833132" fwnested="0" -->
  ...
  <tr>
   <td valign="top" background="images/index_r16_c1.jpg"><table border="0" cellspacing="0" cellpadding="0">
     ...
     <tr>
       <td><a href="prematricula.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('index_r13_c2','','images/index_r13_c2_f2.jpg',1);"><img name="index_r13_c2" src="images/index_r13_c2.jpg" width="122" height="25" border="0" alt="Matr&iacute;cula"></a></td>
     </tr>
     <tr>
   ...
   <td align="center" valign="top"><table border="0" cellpadding="0" cellspacing="0">
     ...
     <tr>
       ...
       <td align="center" background="../../images/ventana_r2_c2.jpg" class="tnormalbn">Haga click en el icono para Bajar el manual de Usuario<br>
         de la Matr&iacute;cula via Internet <br>         
         <a href="manual.zip"><img src="pdf.gif" alt="Formato PDF" width="32" height="32" border="0"></a><a href="manual.zip"> &nbsp;<img src="zip.gif" alt="Formato ZIP" width="32" height="32" border="0"></a></td>
     ...
     <table border="0" cellpadding="0" cellspacing="0">
       ...
       <tr>
         <td><img name="ventana_r1_c1" src="../../images/ventana_r1_c1.jpg" width="12" height="29" border="0" alt=""></td>
         <td align="center" background="../../images/ventana_r1_c2.jpg" class="tlargebb"><strong>DEUDAS DE LA UNIVERSIDAD </strong></td>
         <td><img name="ventana_r1_c4" src="../../images/ventana_r1_c4.jpg" width="11" height="29" border="0" alt=""></td>
       </tr>
       <tr>
         <td background="../../images/ventana_r2_c1.jpg"></td>
         <td align="center" background="../../images/ventana_r2_c2.jpg" class="tnormalbn">
			<?
 			//-------------------------------------------------
			$bDeuda = FALSE;
			$vDeuda = "";
			...
			$xSerdatad = mysql_connect($sConedeu['host'], $sConedeu['user'], $sConedeu['passwd']);
			$vQuery = "Select codigo as num_mat, det_deu from unap.deudor where codigo = '{$sUser['codigo']}' and est_deu = '0'";
			$cDeuda = mysql_query($vQuery, $xSerdatad);
			while($aDeuda = mysql_fetch_array($cDeuda))
			{
				$bDeuda = TRUE;				
				$vDeuda .= $aDeuda['det_deu']. " y ";
			}
			mysql_close($xSerdatad);
			if($bDeuda)
			{
			?>
				Usted tiene las siguientes DEUDAS: <br>
				<strong><?=strtoupper($vDeuda)?></strong><br>
				y no podra realizar su matricula vía INTERNET.<br>
				Cancele su deuda en la dependencia respectiva.
			<?
			}
			else
			{
			?>
				Usted no tiene ninguna DEUDA<br>
				Puede realizar su matricula via INTERNET
			<?
			}
			?>		 </td>
         <td background="../../images/ventana_r2_c4.jpg"></td>
